...
from app.core.storage.models import ShowroomStorageLocation
...
def _log_activity(db, action, entity_type, entity_id, user_id=None, old_value=None, new_value=None):
