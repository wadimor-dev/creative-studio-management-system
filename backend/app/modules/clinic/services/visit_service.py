...
from app.modules.clinic.models.visit import Visit, VisitStatus
...
from app.modules.clinic.models.healthcare_professional import HealthcareProfessional
from app.modules.clinic.schemas import VisitCreate, VisitUpdate, VisitResponse, VisitDetailResponse
...
class VisitService:
    ...
    def get_detail(self, db: Session, visit_id: str) -> VisitDetailResponse:
        ...
        from app.modules.clinic.services.medical_record_service import medical_record_service
        from app.modules.clinic.services.soap_note_service import soap_note_service
        from app.modules.clinic.services.vital_sign_service import vital_sign_service
        from app.modules.clinic.services.diagnosis_service import diagnosis_service
        from app.modules.clinic.services.visit_procedure_service import visit_procedure_service
        from app.modules.clinic.services.prescription_service import prescription_service
        from app.modules.clinic.services.medical_certificate_service import medical_certificate_service
        from app.modules.clinic.services.medical_attachment_service import medical_attachment_service
