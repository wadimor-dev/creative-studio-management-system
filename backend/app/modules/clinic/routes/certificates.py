...
from app.modules.clinic.schemas import MedicalCertificateCreate, MedicalCertificateUpdate
from app.modules.clinic.services import medical_certificate_service
