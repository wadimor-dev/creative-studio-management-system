...
from app.modules.hrd_ga.creative.showroom.routes import dashboard, dashboard_v2, sample, borrowing, guest, stock_control, reporting, master_data, public, storage, qr_scan, manage, movement_types
