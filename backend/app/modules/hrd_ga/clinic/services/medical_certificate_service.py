...
from app.modules.hrd_ga.clinic.models.medical_certificate import MedicalCertificate
from app.modules.hrd_ga.clinic.schemas import MedicalCertificateCreate, MedicalCertificateUpdate, MedicalCertificateResponse
