...
from app.modules.hrd_ga.clinic.models.medical_attachment import MedicalAttachment
from app.modules.hrd_ga.clinic.schemas import MedicalAttachmentCreate, MedicalAttachmentUpdate, MedicalAttachmentResponse
